...
/**
 * Provides implementations of StyleResource.
 */
public final class StyleResourceGenerator extends AbstractResourceGenerator
    ...
    public String createAssignment(TreeLogger logger, ResourceContext context,
        ...
        sw.println("new " + StyleResource.class.getName() + "() {");
        sw.indent();
        ...
        writeEnsureInjectedAtStart(sw);
        writeEnsureInjectedAtEnd(sw);
    ...
    protected void writeEnsureInjectedAtStart(SourceWriter sw) {
        sw.println("public boolean ensureInjectedAtStart() {");
        sw.indent();
        sw.println("if (!injected) {");
        sw.indentln("injected = true;");
    ...
    protected void writeEnsureInjectedAtEnd(SourceWriter sw) {
        sw.println("public boolean ensureInjectedAtEnd() {");
        sw.indent();
        sw.println("if (!injected) {");
        sw.indentln("injected = true;");
        sw.indentln(StyleInjector.class.getName() + ".injectAtEnd(getText());");
        sw.indentln("return true;");
        sw.println("}");
        sw.println("return false;");
        sw.outdent();
